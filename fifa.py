...
df_graph1 = pd.read_csv("df_graph1.csv")
df_game1 = pd.read_csv("df11.csv")
df_pie = pd.read_csv("df_pie.csv")
df_new_p = pd.read_csv('df_new_p.csv')
df4 = pd.read_csv("df4.csv")
df1 = pd.read_csv('df1.csv')
dff = pd.read_csv("Games_chart.csv")
d_comp = pd.read_csv("df_c_new.csv")
